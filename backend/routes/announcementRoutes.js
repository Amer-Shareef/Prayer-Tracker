...
// Create announcement
router.post('/announcements', authenticateToken, authorizeRole(['Founder', 'SuperAdmin']), async (req, res) => {
  try {
...
// Update announcement
router.put('/announcements/:id', authenticateToken, authorizeRole(['Founder', 'SuperAdmin']), async (req, res) => {
  try {
    const { id } = req.params;
...
// Delete announcement
router.delete('/announcements/:id', authenticateToken, authorizeRole(['Founder', 'SuperAdmin']), async (req, res) => {
  try {
    const { id } = req.params;
    const { user } = req;
