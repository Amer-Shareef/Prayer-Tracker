...
const PostFeeds = () => {
  ...
  useEffect(() => {
    ...
    console.log(
      "🔧 UploadThing URL:",
      process.env.REACT_APP_BACKEND_URL || "http://13.60.193.171:5000"
    );
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  ...
                  publish the feed with filename format:
                  ddmmyy_timestamp.extension
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Add a YouTube or video URL to embed with your feed. Uploading
                  will clear any selected image.
                </p>
              </div>
                    ...
                    {feeds.map((feed) => (
                      <tr key={feed.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          >
                            {feed.priority?.charAt(0).toUpperCase() +
                              feed.priority?.slice(1) || "Normal"}
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                ...
                {totalPages > 1 && (
                  <div className="mt-auto mb-8 flex items-center justify-between">
                    <div className="text-sm text-gray-700 pl-3">
                      Showing page {currentPage} of {totalPages} ({totalFeeds}{" "}
                      total feeds)
                    </div>
