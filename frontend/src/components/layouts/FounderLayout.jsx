...
const FounderLayout = ({ children }) => {
    ...
    { 
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 48 48">
          <path className="cls-1" d="M10 21H9a4 4 0 0 0-4 4v6a4 4 0 0 0 4 4h1a1 1 0 0 0 1-1V22a1 1 0 0 0-1-1zM7 31v-6a2 2 0 0 1 2-2v10a2 2 0 0 1-2-2z"/><path className="cls-2" d="M9 23v10a2 2 0 0 1-2-2v-6a2 2 0 0 1 2-2z"/><path className="cls-1" d="M12 19a3 3 0 0 0-2.82 2A2.77 2.77 0 0 0 9 22v12a2.77 2.77 0 0 0 .18 1A3 3 0 0 0 15 34V22a3 3 0 0 0-3-3zm1 15a1 1 0 0 1-2 0V22a1 1 0 0 1 2 0z"/><path className="cls-3" d="M13 22v12a1 1 0 0 1-2 0V22a1 1 0 0 1 2 0z"/><path className="cls-1" d="M39 21h-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h1a4 4 0 0 0 4-4v-6a4 4 0 0 0-4-4zm2 10a2 2 0 0 1-2 2V23a2 2 0 0 1 2 2z"/><path className="cls-2" d="M41 25v6a2 2 0 0 1-2 2V23a2 2 0 0 1 2 2z"/><path className="cls-1" d="M38.82 21A3 3 0 0 0 33 22v12a3 3 0 0 0 5.82 1 2.77 2.77 0 0 0 .18-1V22a2.77 2.77 0 0 0-.18-1zM36 35a1 1 0 0 1-1-1V22a1 1 0 0 1 2 0v12a1 1 0 0 1-1 1z"/><path className="cls-3" d="M37 22v12a1 1 0 0 1-2 0V22a1 1 0 0 1 2 0z"/><path className="cls-1" d="M38 32a1 1 0 0 1-1-1V20a13 13 0 0 0-26 0v11a1 1 0 0 1-2 0V20a15 15 0 0 1 30 0v11a1 1 0 0 1-1 1zM30 43h-6a1 1 0 0 1 0-2h6a7 7 0 0 0 7-7 1 1 0 0 1 2 0 9 9 0 0 1-9 9z"/><path className="cls-1" d="M24 37a3 3 0 0 0 0 6h2a1 1 0 0 0 1-1v-2a3 3 0 0 0-3-3zm1 4h-1a1 1 0 1 1 1-1z"/><circle cx="12" cy="12" r="2" fill="currentColor"/>
        </svg>
      ) 
    },
    { 
  ...
  // Add Area menu item only for SuperAdmin users
  const areaMenuItem = {
    path: '/founder/area',
    label: 'Area',
    bgColor: 'bg-gray-200',
